...
var coordinatesPrep = function () {
  ...
  var iframeLink = 'https://www.google.com/maps/embed/v1/directions?key=AIzaSyAqMCNMooQrQlJcK7bpd3pcMGD1bMmarF4&mode=walking&origin='+ latStart +','+ lonStart +'&destination='+ latEnd +','+ lonEnd;
  iframeEl.setAttribute("src", iframeLink);
};

// var getDirections = function (latStart, latEnd, lonStart, lonEnd) {
//   var apiUrl = "https://api.openrouteservice.org/v2/directions/driving-car?api_key=5b3ce3597851110001cf6248da3361049f304c83b34cb7e9d07c6238&start=8.681495,49.41461&end=8.687872,49.420318"
